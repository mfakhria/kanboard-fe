...
import { Search, Mail, Bell, Menu } from 'lucide-vue-next'
...
<template>
  <header class="sticky top-0 z-30 flex h-16 items-center justify-between border-b bg-white dark:bg-gray-900 px-4 lg:px-8">
    <!-- Mobile menu button -->
    <button class="lg:hidden mr-3 rounded-lg p-2 hover:bg-gray-100 dark:hover:bg-gray-800" @click="emit('toggleSidebar')">
