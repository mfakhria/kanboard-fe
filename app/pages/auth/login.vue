...
<template>
  <div>
      ...
      <form @submit.prevent="handleLogin" class="space-y-4">
        ...
        <div class="space-y-2">
          <div class="flex items-center justify-between">
            ...
            <span class="text-xs text-lime-600 dark:text-lime-400 hover:underline cursor-pointer">
              Forgot password?
            </span>
          </div>
          <UiInput
    ...
    <p class="mt-6 text-center text-sm text-gray-500 dark:text-gray-400">
      ...
      <NuxtLink to="/auth/register" class="font-medium text-lime-600 dark:text-lime-400 hover:underline">
        Sign up
      </NuxtLink>
    </p>
  </div>
